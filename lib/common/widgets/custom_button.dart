...
//     this.fontSize, this.radius = 10, this.icon, this.color, this.textColor, this.isLoading = false, this.isBold = true, this.successtextcolour, this.gradient});
...
class CustomButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Center(child: SizedBox(width: width ?? Dimensions.webMaxWidth, child: Padding(
      ...
      child: TextButton(
        onPressed: isLoading ? null : onPressed as void Function()?,
        style: gradient != null ? TextButton.styleFrom(
          padding: EdgeInsets.zero,
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(radius),
          ),
