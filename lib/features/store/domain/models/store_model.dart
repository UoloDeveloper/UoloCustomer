...
class StoreModel {
  ...
  @override
  String toString() {
    return 'StoreModel(totalSize: $totalSize, limit: $limit, offset: $offset, stores: $stores)';
  }
}
...
class Store {
  ...
  Map<String, dynamic> toJson() {
    ...
    // data['currency'] = categoryModel?.toJson();
    return data;
  }
}
...
//     // Handle currency
//     if (json['zone'] != null && json['zone']['currency'] != null) {
//       currency = CurrencyModel.fromJson(json['zone']['currency']);
//     } else {
//       currency = CurrencyModel(symbol: '\$'); // Fixed currency symbol
//     }
//   }
...
//     }
//     data['vendor_id'] = vendorId;
//     data['prescription Order'] = prescriptionOrder;
//     data['cutlery'] = cutlery;
//     data['slug'] = slug;
//     data['announcement'] = announcementActive;
//     data['announcement_message'] = announcementMessage;
...
//     } else {
//       data['zone'] = {
//         'currency': {'symbol': '\$'}, // Fixed currency symbol
//       };
//     }
