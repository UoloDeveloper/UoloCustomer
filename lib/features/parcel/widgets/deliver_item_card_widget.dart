  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isDeliverItem ? Theme.of(context).primaryColor   : Theme.of(context).cardColor  ,
        border: Border.all(color: isDeliverItem ? Theme.of(context).primaryColor   : Theme.of(context).cardColor),
