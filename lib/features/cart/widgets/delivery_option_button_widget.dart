...
//               color: select  ? widget.fromWeb ? Theme.of(context).primaryColor   : Theme.of(context).cardColor : Colors.transparent,
...
class _DeliveryOptionButtonWidgetState extends State<DeliveryOptionButtonWidget> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CheckoutController>(
      builder: (checkoutController) {
        bool isSelected = checkoutController.orderType == widget.value;
        ...
        return InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: isSelected ? Theme.of(context).primaryColor : Colors.transparent, // Change border color when selected
                width: .5, 
              ),
              boxShadow:
                   const [
...
, // Shadow color
                  ...
                  offset: Offset(0, 2), // Positioning of shadow (x, y)
                ),
              ]
