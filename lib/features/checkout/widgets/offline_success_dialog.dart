          ...
          child: SingleChildScrollView(
            child: Column(children: [
              ...
              RichText(textAlign: TextAlign.center, text: TextSpan(children: [
                TextSpan(text: 'your_payment_has_been_successfully_processed_and_your_order'.tr, style: robotoMedium.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color!  )),
                TextSpan(text: ' #$orderId ', style: robotoBold.copyWith(color: Theme.of(context).primaryColor)),
                TextSpan(text: 'has_been_placed'.tr, style: robotoMedium.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color!  )),
              ])),
              const SizedBox(height: Dimensions.paddingSizeLarge),
