                              ...
                              return InkWell(
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                    ...
                                    boxShadow: isSelected ? [BoxShadow(color: Theme.of(context).disabledColor  , blurRadius: 5)] : null,
                                  ),
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          ...
                                          style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeDefault, color: isSelected ? Theme.of(context).textTheme.bodyMedium!.color : Theme.of(context).textTheme.bodyMedium!.color!  ),
                                        ),
                                      ),

                                      if(!widget.fromChatPage)
                                      Icon(isSelected ? Icons.radio_button_on : Icons.radio_button_off_outlined, color: isSelected ? Theme.of(context).primaryColor : Theme.of(context).textTheme.bodyMedium!.color!  ),
                                    ],
                                  ),
                                ),
                              );
