        ...
        return Shimmer(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(color: Get.isDarkMode ? Colors.black12 : Colors.grey  , spreadRadius: 1, blurRadius: 5, offset: const Offset(0, 1))],
            ),
            child: Row(children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                  color: Get.isDarkMode ? Theme.of(context).disabledColor   : Theme.of(context).cardColor,
                ),
              ),
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                  Container(height: 20, width: double.maxFinite, color: Get.isDarkMode ? Theme.of(context).disabledColor   : Theme.of(context).cardColor),
                  const SizedBox(height: Dimensions.paddingSizeSmall),
                  Container(height: 15, width: double.maxFinite, color: Get.isDarkMode ? Theme.of(context).disabledColor   : Theme.of(context).cardColor),
                  const SizedBox(height: Dimensions.paddingSizeSmall),
                  Container(height: 15, width: double.maxFinite, color: Get.isDarkMode ? Theme.of(context).disabledColor   : Theme.of(context).cardColor),
                ]),
              ),
